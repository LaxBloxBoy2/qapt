-- Simple Finances Module Schema
-- Creates all tables first, then adds constraints
...
-- Insert default categories BEFORE adding foreign keys
...
DO $$
BEGIN
  -- Add self-reference for categories parent_id
  BEGIN
...
-- Insert subcategories AFTER foreign keys are added
...
-- Success message
SELECT 'Simple finances module schema created successfully!' as message;
