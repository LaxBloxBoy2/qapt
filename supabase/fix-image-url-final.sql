-- Final fix for image_url bucket and photos
-- This script ensures proper bucket configuration and fixes URLs
...
-- 3. Create new policies with simpler conditions
...
-- 4. Fix the URLs in the property_photos table
...
-- 5. Enable RLS on the objects table
