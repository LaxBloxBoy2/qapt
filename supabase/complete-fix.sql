-- COMPREHENSIVE FIX FOR PROPERTY RELATIONSHIP ISSUES

-- 1. First, drop any views that depend on the property_id column
...
-- 4. Force create the Reinold AP property
DO $$
DECLARE
...
-- 5. Add back the foreign key constraint
ALTER TABLE IF EXISTS public.inspections
...
-- 6. Recreate the RLS policies for inspections
...
-- 7. Recreate the RLS policies for inspection_sections
...
-- 8. Recreate the RLS policies for inspection_conditions
...
-- 8. Recreate the RLS policies for inspection_media
