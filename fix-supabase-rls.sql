...
-- Create trigger function to create user profiles
...
CREATE OR REPLACE FUNCTION public.create_profile_for_user(user_id UUID, user_full_name TEXT, user_role TEXT)
RETURNS VOID AS $$
BEGIN
  -- Disable RLS temporarily
  ALTER TABLE public.user_profiles DISABLE ROW LEVEL SECURITY;
